...
require.config ({
   ...
   paths: {
    ...
    //Modules
    'iseApp'                 : '/ise/resources/assets/js/iseApp',
    'notificacao'            : '/ise/resources/assets/js/notificacao',
    'estatistica'            : '/ise/resources/assets/js/estatistica',
    'versao'                 : '/ise/resources/assets/js/versao',
    'mod_secretaria_escola'  : '/ise/resources/assets/js/mod_secretaria_escola',
    'filters'                : '/ise/resources/assets/js/filters',
    'directives'             : '/ise/resources/assets/js/directives',
//    'services'               : '/ise/resources/assets/js/services',
   },
   waitSeconds: 0,
    shim: {
    		'jquery': {
